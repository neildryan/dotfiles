# Generated by config wizard 20202-10-12, 22:06 PDT
# options: powerline, ascii, lean, 2 lines, dotted, darkest-ornaments, compact,
...
() {
  ...
  # Neil: Commented segments have config removed, would need to re-config to use
